...
const adminDict = {
  ...
  combinations: {
    ...
    bulkGenerate: {
      ...
      description: "Eksik kombinasyonları GitHub Actions üzerinde üretir ve canonical Firestore kayıtlarına ekler.",
      ...
      queuedStatus: "Kuyruğa alındı",
      waitingWorker: "GitHub worker'ın başlaması bekleniyor.",
      running: "Arka planda çalışıyor... ({done}/{total})",
      stoppingStatus: "Durduruluyor... ({done}/{total})",
      backgroundNote: "İşlem arka planda devam eder; bu sayfayı veya tarayıcıyı kapatabilirsiniz.",
      doneAll: "Tüm kombinasyonlar başarıyla üretildi!",
      draftNote: "Kayıtlar canonical taslak alanına eklendi; canlı site yayın sınırı değişmedi.",
      ...
      queuedToast: "Toplu içerik üretimi kuyruğa alındı.",
      errorAlreadyRunning: "Başka bir toplu içerik görevi zaten kuyruğa alınmış veya çalışıyor.",
      errorGithubConfig: "GitHub Actions bağlantı ayarları eksik veya geçersiz.",
      errorDispatch: "Arka plan görevi GitHub Actions'a gönderilemedi. Lütfen tekrar deneyin.",
      ...
      failedUnknownItem: "bilinmeyen kombinasyon",
      failedBeforeWorker: "Arka plan worker'ı başlamadan görev başarısız oldu. Hiçbir kombinasyon işlenmedi.",
      failedSummary: "İşlem {item} kaydında durdu. {done}/{total} kombinasyon tamamlandı; kalan kombinasyonlar işlenmedi.",
      restartNote: "Yeniden başlattığınızda mevcut kayıtlar atlanır ve yalnızca eksik kombinasyonlar işlenir.",
      abortedSummary: "İşlem durduruldu. {done}/{total} kombinasyon tamamlandı; kalan kombinasyonlar işlenmedi.",
      staleSummary: "Arka plan görevi askıda kaldı. {done}/{total} kombinasyon tamamlandı; kalan kombinasyonlar işlenmedi. Eksikleri yeniden başlatabilirsiniz.",
      attemptProgress: "{attempt}/{max} deneme",
      maxAttempts: 3,
      workerHelp: "Kullanım: npm run combinations:worker -- --job-id <uuid>",
    },
    bulkMutation: {
      title: "Toplu İşlem",
