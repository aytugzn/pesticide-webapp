...
const adminDict = {
  ...
  regions: {
    ...
    formSlug: "Slug (URL - Değiştirilemez)",
    formDesc: "Açıklama",
    isActive: "Aktif (Göster)",
    saving: "Kaydediliyor...",
    save: "Kaydet",
    add: "Ekle",
    update: "Güncelle",
  ...
  pests: {
    ...
    formName: "Haşere Adı (Örn: Fare)",
    formSlug: "Slug (URL - Değiştirilemez)",
    formImage: "Resim URL (Opsiyonel)",
    formDesc: "Açıklama (Opsiyonel)",
    isActive: "Aktif (Göster)",
...
const systemErrorsDict = {
  ...
  logs: {
    ...
    deleteRegion: "Error deleting region",
    fetchPests: "Error fetching pests",
    createPest: "Error creating pest",
    updatePest: "Error updating pest",
    deletePest: "Error deleting pest",
    fetchCombinations: "Error fetching combinations",
    createCombination: "Error creating combination",
    updateCombination: "Error updating combination",
