...
/**
 * Initializes or reuses the server-only Firebase Admin application.
 *
 * @returns Configured Firebase Admin application
 */
...
/**
 * Resolves the Firestore client from the configured Firebase Admin application.
 *
 * @returns Firebase Admin Firestore client
 */
