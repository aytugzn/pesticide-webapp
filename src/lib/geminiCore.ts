...
/**
 * Resolves configured Gemini API keys without exposing them to client modules.
 *
 * @returns Ordered Gemini API keys, or an empty array when unconfigured
 */
...
/**
 * Returns a cached Gemini model for the selected credential and model name.
 *
 * @param apiKey - Optional Gemini credential override
 * @param modelName - Gemini model identifier
 * @returns Configured Gemini generative model
 */
...
/**
 * Builds a strictly formatted regional SEO content prompt.
 *
 * @param region - Region name and local description
 * @returns Formatted prompt requesting structured JSON output
 */
...
/**
 * Builds a strictly formatted pest-specific SEO content prompt.
 *
 * @param pest - Pest name and descriptive context
 * @returns Formatted prompt requesting structured JSON output
 */
